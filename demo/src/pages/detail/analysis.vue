    ...
    <div class="sales-board-form">
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <counter :max="100" :min="20" @on-change="onParamChange('buyNum',$event)"></counter>
      ...
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          ...
          <selection :selections="productTypes" @on-change="onParamChange('buyType',$event)"></selection>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">
        ...
        <div class="sales-board-line-right">
          <chooser :selections="buyTypes" @on-change="onParamChange"></chooser>
